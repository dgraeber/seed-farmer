...
The Industrial Data Framework (IDF) modules are reusable infrastructure components designed to help you build data processing and analytics solutions on AWS.
